...
echo "Build second stage libc++ arm64 rt"
cmake -G Ninja -S llvm-project/runtimes -B build-libcxx-stage2-arm64-rt \
...
cmake --build build-libcxx-stage2-arm64-rt -- -j 16
cmake --install build-libcxx-stage2-arm64-rt
